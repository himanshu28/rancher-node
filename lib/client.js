...
class RancherClient {
    ...
    stopContainer(containerId) {
        Joi.assert(containerId, Joi.string().required(), 'Must specify container id');
        return this._request('post', `/v2-beta/projects/1a5/container/${containerId}/?action=stop`);
    }
    ...
    restartContainer(containerId, restartParams) {
        Joi.assert(containerId, Joi.string().required(), 'Must specify container id');
        return this._request('post', `/v2-beta/projects/1a5/container/${containerId}/?action=restart`, { payload: JSON.stringify(restartParams) });
    }
